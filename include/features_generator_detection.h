#ifndef _FEATURES_GENERATOR_DETECTION_H_
#define _FEATURES_GENERATOR_DETECTION_H_

#include "features_generator.h"

template <class TPath>
class FeaturesGenerator_Detection : public FeaturesGenerator
{
	public:
		typedef TPath Path;
		...
		FeaturesGenerator_Detection(const std::string& outputFilename, const std::string& term, const mlf::MlfRecords<ReferenceMlfRecord>& recsRef) : 
